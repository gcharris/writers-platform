...
DeepSeek is known for its strong reasoning capabilities and cost-effectiveness.
"""
...
class DeepSeekAgent(BaseAgent):
    """DeepSeek agent for text generation.
    ...
    def __init__(self, config: AgentConfig):
        ...
        logger.info(f"Initialized DeepSeek agent with model '{self.model}'")
